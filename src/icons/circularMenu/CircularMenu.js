...
const CircularMenu = () => {
  ...
  return (
    <svg version="1.1" stroke="currentColor" fill="currentColor" style={{ transform: 'rotate(90deg)' }} strokeWidth="0" height="1em" width="1em" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
